...
public class SmartsViewerNodeDialog extends DefaultNodeSettingsPane {
	...
	protected SmartsViewerNodeDialog() {
		...
		addDialogComponent(new DialogComponentColumnNameSelection(
				...
				"Select a column containing the SMARTS Strings:", 0, true, SmilesValue.class,
				StringValue.class, SmartsValue.class));
		closeCurrentGroup();

		createNewGroup("Renderer Settings");
		// addDialogComponent (new DialogComponentButtonGroup(
		// new SettingsModelString(SmartsViewerNodeModel.CFG_IMG_FORMAT,"png"),
		// "Select image format",
		// false, new String[] {"PNG Image","SVG Image"}, new String[]
		// {"png","svg"}));

		addDialogComponent(new DialogComponentButtonGroup(
				new SettingsModelString(SmartsViewerNodeModel.CFG_LEGEND, "both"),
				"Select legend type", false, new String[] { "Both", "None", "Static", "Dynamic" },
				new String[] { "both", "none", "static", "dynamic" }));

		addDialogComponent(new DialogComponentButtonGroup(
				new SettingsModelString(SmartsViewerNodeModel.CFG_VIS_MODUS, "1"),
