 ...
 * @author
 */
public class FlowVarEndCaseNodeModel extends NodeModel implements
		InactiveBranchConsumer {
	private static final NodeLogger logger = NodeLogger
			.getLogger(FlowVarEndCaseNodeModel.class);
	private static final int m_InPorts = 3;
	private static final PortType m_portType = FlowVariablePortObject.TYPE;

	/**
	 * Constructor for the node model.
	 */
	protected FlowVarEndCaseNodeModel() {
