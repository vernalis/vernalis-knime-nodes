 ...
 */
public class PdbConnectorXmlQueryNodeFactory
        extends NodeFactory<PdbConnectorXmlQueryNodeModel> {
    ...
    public PdbConnectorXmlQueryNodeModel createNodeModel() {
        return new PdbConnectorXmlQueryNodeModel(PdbConnectorConfig.getInstance());
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new PdbConnectorXmlQueryNodeDialog(PdbConnectorConfig.getInstance());
    }
