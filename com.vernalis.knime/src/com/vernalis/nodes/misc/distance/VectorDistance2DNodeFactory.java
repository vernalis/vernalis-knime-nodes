...
/**
 * {@link NodeFactory} for the 2D Distance node
 * 
 * @author s.roughley
 *
 */
public class VectorDistance2DNodeFactory
		extends NodeFactory<AbstractVectorDistanceNodeModel> {

	@Override
	public AbstractVectorDistanceNodeModel createNodeModel() {
		return new AbstractVectorDistanceNodeModel('x', 'y') {
		};
	}
	...
	protected NodeDialogPane createNodeDialogPane() {
		return new AbstractVectorDistanceNodeDialog('x', 'y');
	}
