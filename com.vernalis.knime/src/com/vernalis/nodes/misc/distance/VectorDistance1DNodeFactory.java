...
/**
 * {@link NodeFactory} for the 1D Distance node
 * 
 * @author s.roughley
 *
 */
public class VectorDistance1DNodeFactory
		extends NodeFactory<AbstractVectorDistanceNodeModel> {

	@Override
	public AbstractVectorDistanceNodeModel createNodeModel() {
		return new AbstractVectorDistanceNodeModel(false) {
		};
	}
	...
	protected NodeDialogPane createNodeDialogPane() {
		return new AbstractVectorDistanceNodeDialog(false);
	}
