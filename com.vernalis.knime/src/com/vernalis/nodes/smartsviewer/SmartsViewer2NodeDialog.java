...
//        		new SettingsModelString(SmartsViewer2NodeModel.CFG_IMG_FORMAT,"png"), "Select image format",
//        		false, new String[] {"PNG Image","SVG Image"}, new String[] {"png","svg"}));
        
        addDialogComponent (new DialogComponentButtonGroup(
        		new SettingsModelString(SmartsViewer2NodeModel.CFG_LEGEND,"both"), "Select legend type",
        		false, new String[] {"Both","None","Static","Dynamic"}, new String[] {"both","none","static","dynamic"}));
        
        addDialogComponent (new DialogComponentButtonGroup(
        		new SettingsModelString(SmartsViewer2NodeModel.CFG_VIS_MODUS,"1"), "Select Visualition modus",
