...
/**
 * <code>NodeView</code> for the "RCSBmultiDownload" Node.
...
public class RCSBmultiDownloadNodeView extends NodeView<RCSBmultiDownloadNodeModel> {
     ...
     * Creates a new view.
     * 
     * @param nodeModel The model (class: {@link RCSBmultiDownloadNodeModel})
     */
    protected RCSBmultiDownloadNodeView(final RCSBmultiDownloadNodeModel nodeModel) {
        super(nodeModel);
