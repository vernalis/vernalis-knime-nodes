 ...
 *
 */
package com.vernalis.knime.plot.jfreechart;
 ...
 *
 * @author %Bundle-Vendor
 */
public class VernalisJFreeChartNodePlugin extends Plugin {
    // The shared instance.
    private static VernalisJFreeChartNodePlugin plugin;

    /**
     * The constructor.
     */
    public VernalisJFreeChartNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static VernalisJFreeChartNodePlugin getDefault() {
        return plugin;
    }
