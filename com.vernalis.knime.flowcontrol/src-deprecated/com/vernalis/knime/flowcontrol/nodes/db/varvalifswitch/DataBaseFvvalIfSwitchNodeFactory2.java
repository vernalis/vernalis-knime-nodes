 ...
 *******************************************************************************/
package com.vernalis.knime.flowcontrol.nodes.db.varvalifswitch;
 ...
 */
@Deprecated
public class DataBaseFvvalIfSwitchNodeFactory2
		extends NodeFactory<AbstractFvvalIfSwitchNodeModel2> {

	/** The port type. */
	PortType m_port = DatabasePortObject.TYPE;
