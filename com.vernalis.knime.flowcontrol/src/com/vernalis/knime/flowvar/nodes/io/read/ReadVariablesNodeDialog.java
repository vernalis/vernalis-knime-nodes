...
import com.vernalis.knime.flowvar.nodes.io.write.WriteVariablesNodeDialog;

/**
 * <code>NodeDialog</code> for the "ReadVariables" Node.
 * 
 * 
 ...
 * @author
 */
public class ReadVariablesNodeDialog extends DefaultNodeSettingsPane {

	/**
	 * New pane for configuring ReadVariables node dialog.
	 */
	protected ReadVariablesNodeDialog() {
		super();
	...
	/**
	 * Creates the duplicate model.
	 * 
	 * @return the settings model string
	 */
	static final SettingsModelString createDuplicateModel() {
		return new SettingsModelString("Duplicate Variable Policy",
				DuplicateVariablePolicy.getDefaultMethod().getActionCommand());
	}
