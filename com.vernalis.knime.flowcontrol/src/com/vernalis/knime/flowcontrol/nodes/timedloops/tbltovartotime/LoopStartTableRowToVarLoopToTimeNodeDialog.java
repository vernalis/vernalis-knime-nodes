...
/**
 * <code>NodeDialog</code> for the "LoopStartTableRowToVarLoopToTime" Node. A
 ...
 */
public class LoopStartTableRowToVarLoopToTimeNodeDialog extends
		AbstractTimedLoopStartNodeDialog {

	/**
	 * New pane for configuring the LoopStartTableRowToVarLoopToTime node.
	 */
	protected LoopStartTableRowToVarLoopToTimeNodeDialog() {
		super();
