 ...
 *******************************************************************************/
package com.vernalis.knime.flowcontrol.nodes.wait.totime;
 ...
 */
public class WaitToTimeNodeDialog extends AbstractTimedLoopStartNodeDialog {

	/**
	 * Constructor.
	 */
	public WaitToTimeNodeDialog() {
		super();
		addRunToTimePanel();
	}
