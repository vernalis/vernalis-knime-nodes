 ...
 * such that any value of an array flow variable must pass the test
 * 
 ...
 */
public class AnyArrayFlowVarConditionAdapter<T>
	 ...
	 */
	public AnyArrayFlowVarConditionAdapter(FlowVarCondition<T> cond,
	...
	@Override
	public String getID() {
		return "Array Any(" + cond.getID() + ")";
	}

	@Override
	public String getDisplayName() {
		return "Any " + cond.getID();
	}
	...
	public List<ComponentWrapper<?, ?, ?>> getReferenceComponents() {
		List<ComponentWrapper<?, ?, ?>> retVal = cond.getReferenceComponents();
		retVal.add(
