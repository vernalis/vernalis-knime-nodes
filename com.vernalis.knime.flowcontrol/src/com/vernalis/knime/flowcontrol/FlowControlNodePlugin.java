 ...
 * @author SDR
 */
public class FlowControlNodePlugin extends Plugin {

	/** The plugin shared instance */
	private static FlowControlNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public FlowControlNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static FlowControlNodePlugin getDefault() {
		return plugin;
	}
