 ...
 *
 */
package com.vernalis.knime.chem.core;
 ...
 */
public class VernalisChemCoreNodePlugin extends Plugin {

	// The shared instance.
	private static VernalisChemCoreNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public VernalisChemCoreNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static VernalisChemCoreNodePlugin getDefault() {
		return plugin;
	}
