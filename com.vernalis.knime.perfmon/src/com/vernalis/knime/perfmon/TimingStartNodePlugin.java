 ...
 * @author S. Roughley
 */
public class TimingStartNodePlugin extends Plugin {
    // The shared instance.
    private static TimingStartNodePlugin plugin;

    /**
     * The constructor.
     */
    public TimingStartNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TimingStartNodePlugin getDefault() {
        return plugin;
    }
