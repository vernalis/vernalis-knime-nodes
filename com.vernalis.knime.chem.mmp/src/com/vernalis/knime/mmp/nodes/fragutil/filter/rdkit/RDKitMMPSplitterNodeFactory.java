...
/**
 * Node Factory class for the MMP splitter node RDKit implementation
 * 
 * @author s.roughley {@literal <knime@vernalis.com>}
 * 
 */
public class RDKitMMPSplitterNodeFactory
		extends AbstractMMPFragmentationFilterSplitterNodeFactory<RWMol, ROMol> {

	/**
	 * Constructor
	 */
	public RDKitMMPSplitterNodeFactory() {
		super(RWMolFragmentationUtilsFactory.class, true);
	}
}
