...
public class RdkitMatchedPairsNodeModel extends
	...
	protected BufferedDataTable[] execute(BufferedDataTable[] inData,
		...
		final BufferedDataContainer dc_0 = exec.createDataContainer(m_spec);
		// And a table for unprocessed rows
		final BufferedDataContainer dc_1 = exec.createDataContainer(spec);
		...
		if (m_outputKey.getBooleanValue() || m_outputHARatio.getBooleanValue()) {
			// We need the overloaded method with the full paramter list, and to
