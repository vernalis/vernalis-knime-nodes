...
/**
 * The node factory for the RDKit implementation of the MMP Fragment node. This
 * is a replacement for the class with the same name, suffixed 'Old' to overcome
 * RDKit segfaults as of v3.3.1
 * 
 * @author s.roughley
 * 
 */
public class ParallelRdkitMMPFragment3NodeFactoryv3
		extends AbstractMMPFragmentNodeFactory<RWMol, ROMol> {

	/**
	 * Constructor - Supplies version=3 to force backwards-compatible settings
	 */
	public ParallelRdkitMMPFragment3NodeFactoryv3() {
		super(false, RWMolFragmentationUtilsFactory.class, 3);
	}
