...
/**
 * Node dialog pain for the Multiple Cut (1-N) Fragmentation Node
 * 
...
public class MultipleCutParallelRdkitMMPFragment3NodeDialog extends DefaultNodeSettingsPane {
	...
	/**
	 * Update the status of the fingerprint settings
	 */
	...
	/**
	 * Update settings dependent on the number of cuts
	 */
	...
	/**
	 * Update the number of changing atoms filter
	 */
	 ...
	 * 
	 * @deprecated Setting nolonger used - always {@code true}
	 */
	@Deprecated
