...
public class ComponentFactory2 {
	 ...
	 * @return the Boolean settings model
	 */
	public static SettingsModelBoolean createSelectionSettingsModel(ReportField2 field) {
	 ...
	 * @return the Boolean dialog component.
	 */
	public static DialogComponentBoolean createSelectionDialogComponent(ReportField2 field) {
		return (field != null)
	...
	public static void setNumberFormat(DialogComponentNumber dlg, String formatPattern) {
		...
		for (Component comp : ComponentFactory2.getAllSubComponents(dlg.getComponentPanel(),
				null)) {
