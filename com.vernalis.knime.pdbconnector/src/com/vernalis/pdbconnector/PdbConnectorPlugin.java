 ...
 */
public class PdbConnectorPlugin extends Plugin {

	// The shared instance.
	private static PdbConnectorPlugin plugin;

	/**
	 * The constructor.
	 */
	public PdbConnectorPlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static PdbConnectorPlugin getDefault() {
		return plugin;
	}
