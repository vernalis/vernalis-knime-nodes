...
/**
 * Node Factory for the PDB Query builder node
 */
public class PdbQueryBuilderNodeFactory extends AbstractPdbConnectorNodeFactory {

	public PdbQueryBuilderNodeFactory() {
