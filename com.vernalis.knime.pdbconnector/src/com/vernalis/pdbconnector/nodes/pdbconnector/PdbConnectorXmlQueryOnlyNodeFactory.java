...
/**
 * Node factory class for the PDB Connector XML Query Only Node
 */
public class PdbConnectorXmlQueryOnlyNodeFactory extends AbstractPdbConnectorNodeFactory {

	public PdbConnectorXmlQueryOnlyNodeFactory() {
