...
public abstract class AbstractXMLQueryProviderNodeModel extends NodeModel {
	 ...
	 */
	public AbstractXMLQueryProviderNodeModel(int nrInDataPorts, int nrOutDataPorts) {
	 ...
	 * @param outPortTypes
	 */
	public AbstractXMLQueryProviderNodeModel(PortType[] inPortTypes, PortType[] outPortTypes) {
