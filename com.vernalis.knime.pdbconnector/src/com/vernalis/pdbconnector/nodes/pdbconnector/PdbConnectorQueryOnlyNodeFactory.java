...
/**
 * Node Factory class for the Query-only PdbConnector node
 * 
 * @author S.Roughley
 *
 */
public class PdbConnectorQueryOnlyNodeFactory extends AbstractPdbConnectorNodeFactory {

	/**
	 * Constructor for the node factory
	 */
	public PdbConnectorQueryOnlyNodeFactory() {
