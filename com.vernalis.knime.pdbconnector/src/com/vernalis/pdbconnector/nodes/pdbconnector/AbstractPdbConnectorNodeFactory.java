...
public abstract class AbstractPdbConnectorNodeFactory
	 ...
	 */
	public AbstractPdbConnectorNodeFactory(boolean hasQueryBuilder, boolean runQuery,
			boolean runReport) {
	...
	public AbstractPdbConnectorNodeModel createNodeModel() {
		return new AbstractPdbConnectorNodeModel(PdbConnectorConfig2.getInstance(),
				m_hasQueryBuilder, m_runQuery, m_runReport);
	}
	...
	protected NodeDialogPane createNodeDialogPane() {
		return new AbstractPdbConnectorNodeDialog(PdbConnectorConfig2.getInstance(),
				m_hasQueryBuilder, m_runQuery, m_runReport);
	}
