 ...
 * and stores a {@code int} value
 * 
 * @author S.Roughley knime@vernalis.com
 * @since 1.28.0
 *
 */
public class ChangeableIntSpinner extends JSpinner implements Changeable {
	 ...
	 *            The step size
	 */
	public ChangeableIntSpinner(int val, int min, int max, int stepSize) {
	...
	public void setMin(int min) {
		getModel().setMinimum(Integer.valueOf(min));
	}
	...
	public void setMax(int max) {
		getModel().setMaximum(Integer.valueOf(max));
	}
}
