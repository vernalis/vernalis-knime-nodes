 ...
 * category</LI>
 * <LI>A collection of Boolean dialog components to represent the report fields
 * </LI>
 * </UL>
 * 
 * @deprecated Use {@link ReportCategoryDialog2}
 */
@Deprecated
...
public class ReportCategoryDialog extends JPanel {
	 ...
	 *            the report category
	 */
	public ReportCategoryDialog(final ReportCategory category) {
		m_reportCategory = category;
		...
		for (final ReportField field : m_fields) {
	...
	public void applyStandardReport(final StandardReport stdReport) {
		if (!m_lock && (stdReport != null)) {
			...
			while (fieldIter.hasNext() && dlgIter.hasNext()) {
				...
				for (Component comp : ComponentFactory2.getAllSubComponents(dlgPanel, null)) {
