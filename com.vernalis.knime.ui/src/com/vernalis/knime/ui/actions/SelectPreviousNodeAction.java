 ...
 * all nodes directly upstream of the current selection
 * 
 * @author S.Roughley knime@vernalis.com
 *
 */
public class SelectPreviousNodeAction extends AbstractNodeAction {
	 ...
	 */
	public SelectPreviousNodeAction(WorkflowEditor editor) {
		super(editor);
	}
	...
	public ImageDescriptor getDisabledImageDescriptor() {
		return ImageRepository.getIconDescriptor(
				...
				"icons/select_prev_disabled.png");
	}
	...
	public ImageDescriptor getImageDescriptor() {
		return ImageRepository.getIconDescriptor(
				VernalisUIPluginActivator.PLUGIN_ID, "icons/select_prev.png");
	}
