...
import static com.vernalis.knime.ui.WorkflowHelpers.getAllUpstreamConnectedNodes;
 ...
 * nodes upstream of the current selection
 * 
 * @author S.Roughley knime@vernalis.com
 *
 */
public class SelectAllUpstreamNodesAction extends AbstractNodeAction {
	 ...
	 */
	public SelectAllUpstreamNodesAction(WorkflowEditor editor) {
		super(editor);
	}
	...
	public String getText() {
		return "Select All Upstream Nodes";
	}
	...
	public String getToolTipText() {
		return "Select all nodes upstream of any selected nodes";
	}
	...
	public void runOnNodes(NodeContainerEditPart[] nodeParts) {
		Set<NodeContainerEditPart> toSelect =
				getAllUpstreamConnectedNodes(nodeParts);
		if (toSelect != null) {
	...
	public ImageDescriptor getDisabledImageDescriptor() {
		return ImageRepository.getIconDescriptor(
				...
				"icons/select_all_prev_disabled.png");
	}
