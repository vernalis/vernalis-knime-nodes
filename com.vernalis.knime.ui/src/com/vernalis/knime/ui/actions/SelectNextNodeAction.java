...
/**
 * AbstractNodeAction implementation to extend the current selection to include
 * the directly downstream nodes
 * 
 * @author S.Roughley knime@vernalis.com
 *
 */
public class SelectNextNodeAction extends AbstractNodeAction {
	 ...
	 */
	public SelectNextNodeAction(WorkflowEditor editor) {
		super(editor);
	}
	...
	public String getToolTipText() {
		return "Select all nodes directly following any selected nodes";
	}
	...
	public ImageDescriptor getDisabledImageDescriptor() {
		return ImageRepository.getIconDescriptor(
				...
				"icons/select_next_disabled.png");
	}
	...
	public ImageDescriptor getImageDescriptor() {
		return ImageRepository.getIconDescriptor(
				VernalisUIPluginActivator.PLUGIN_ID, "icons/select_next.png");
	}
