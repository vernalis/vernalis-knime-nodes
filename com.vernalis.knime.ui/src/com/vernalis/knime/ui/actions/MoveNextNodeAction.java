...
/**
 * AbstractNodeAction implementation to move the selection downstream to the
 * next directly-connected node(s)
 * 
 * @author S.Roughley knime@vernalis.com
 *
 */
public class MoveNextNodeAction extends AbstractNodeAction {
	 ...
	 */
	public MoveNextNodeAction(WorkflowEditor editor) {
		super(editor);
	}
	...
	public String getToolTipText() {
		return "Move the selection to all nodes directly following any selected nodes";
	}
	...
	public void runOnNodes(NodeContainerEditPart[] nodeParts) {
		Set<NodeContainerEditPart> toSelect =
				getDownstreamConnectedNodes(nodeParts);
		if (toSelect != null) {
	...
	public ImageDescriptor getImageDescriptor() {
		return ImageRepository.getIconDescriptor(
				VernalisUIPluginActivator.PLUGIN_ID, "icons/move_next.png");
	}
