 ...
 */
public class VernalisKnimeChemRdkitNodePlugin extends Plugin {

	// The shared instance.
	private static VernalisKnimeChemRdkitNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public VernalisKnimeChemRdkitNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static VernalisKnimeChemRdkitNodePlugin getDefault() {
		return plugin;
	}
