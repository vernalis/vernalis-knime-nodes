 ...
 ******************************************************************************/
package com.vernalis.knime.core;
 ...
 * @author 
 */
public class VernalisCoreNodePlugin extends AbstractUIPlugin {
    // The shared instance.
    private static VernalisCoreNodePlugin plugin;

    /**
     * The constructor.
     */
    public VernalisCoreNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static VernalisCoreNodePlugin getDefault() {
        return plugin;
    }
