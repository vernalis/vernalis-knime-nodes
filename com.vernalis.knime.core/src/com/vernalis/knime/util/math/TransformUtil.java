...
/**
 * Utility class with methods relaitng to matrix transformations
 * 
 * @author s.roughley
 * 
 */
public class TransformUtil {
	...
	public static double[] makeRotationMatrix(double[][] inertialTensor)
		...
		double[] r1 = new double[3], r2 = new double[3], v1 = new double[3],
				v2 = new double[3], v3 = new double[3];
		// int i, j, k, l;
		...
		// The 3rd unit vector - unitPlaneNormal product of the 1st two vectors
		...
		// The 2nd unit vector - unitPlaneNormal product of v3 and the 1st (r1)
