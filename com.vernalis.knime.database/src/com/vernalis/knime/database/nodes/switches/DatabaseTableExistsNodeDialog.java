...
/**
 * Node Settings Pane implementation for the Database Table Exists (Flow
 * Variable) node
 * 
 * @author s.roughley
 *
 */
public class DatabaseTableExistsNodeDialog extends DefaultNodeSettingsPane {
	...
	public DatabaseTableExistsNodeDialog() {
		super();
