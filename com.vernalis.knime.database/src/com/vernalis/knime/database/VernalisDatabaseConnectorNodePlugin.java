 ...
 * @author S. Roughley
 */
public class VernalisDatabaseConnectorNodePlugin extends AbstractUIPlugin {
	// The shared instance.
	private static VernalisDatabaseConnectorNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public VernalisDatabaseConnectorNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static VernalisDatabaseConnectorNodePlugin getDefault() {
		return plugin;
	}
