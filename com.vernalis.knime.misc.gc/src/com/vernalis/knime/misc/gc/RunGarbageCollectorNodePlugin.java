 ...
 ******************************************************************************/
package com.vernalis.knime.misc.gc;
 ...
 * @author
 */
public class RunGarbageCollectorNodePlugin extends Plugin {

	// The shared instance.
	private static RunGarbageCollectorNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public RunGarbageCollectorNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static RunGarbageCollectorNodePlugin getDefault() {
		return plugin;
	}
