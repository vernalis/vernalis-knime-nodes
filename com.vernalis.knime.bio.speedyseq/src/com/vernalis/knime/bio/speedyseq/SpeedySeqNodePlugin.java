 ...
 * @author S Roughley
 */
public class SpeedySeqNodePlugin extends Plugin {

	// The shared instance.
	private static SpeedySeqNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public SpeedySeqNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static SpeedySeqNodePlugin getDefault() {
		return plugin;
	}
