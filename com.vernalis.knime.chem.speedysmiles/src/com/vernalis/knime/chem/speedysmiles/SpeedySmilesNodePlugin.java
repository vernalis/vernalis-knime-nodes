 ...
 *
 */
package com.vernalis.knime.chem.speedysmiles;
 ...
 * @author S Roughley
 */
public class SpeedySmilesNodePlugin extends Plugin {
    // The shared instance.
    private static SpeedySmilesNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpeedySmilesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpeedySmilesNodePlugin getDefault() {
        return plugin;
    }
