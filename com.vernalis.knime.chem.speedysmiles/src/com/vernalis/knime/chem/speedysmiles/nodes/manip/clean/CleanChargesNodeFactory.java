...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.cleanMonoCharges;
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.replaceDeprecatedCharges;

/**
 * @author s.roughley
 *
 */
public class CleanChargesNodeFactory
	...
	public AbstractSpeedySmilesSingleCellManipNodeModel createNodeModel() {
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory.createAdapterCell(cleanMonoCharges(
						replaceDeprecatedCharges(smilesValue)));
			}
