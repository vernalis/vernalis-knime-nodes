 ...
 *******************************************************************************/
package com.vernalis.knime.chem.speedysmiles.nodes.manip.clean;
...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.removeAromaticBonds;
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.removeUnnecessarySingleBonds;

/**
 * @author s.roughley
 *
 */
public class CleanBondsNodeFactory
	...
	public AbstractSpeedySmilesSingleCellManipNodeModel createNodeModel() {
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory.createAdapterCell(removeAromaticBonds(
						removeUnnecessarySingleBonds(smilesValue)));
			}
