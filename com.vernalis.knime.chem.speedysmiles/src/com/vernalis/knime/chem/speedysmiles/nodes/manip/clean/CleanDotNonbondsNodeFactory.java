...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.cleanUpNonBonds;

/**
 * @author s.roughley
 *
 */
public class CleanDotNonbondsNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory
						.createAdapterCell(cleanUpNonBonds(smilesValue));
			}
