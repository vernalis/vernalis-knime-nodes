 ...
 *******************************************************************************/
package com.vernalis.knime.chem.speedysmiles.nodes.filter.dummyatoms;
...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.hasDummyAtom;
 ...
 * @author S Roughley
 */
public class DummyAtomsSplitterNodeFactory
	...
	public AbstractSpeedySmilesFilterNodeModel createNodeModel() {
		return new AbstractSpeedySmilesFilterNodeModel(true) {
			...
			protected boolean rowMatches(String smilesValue) {
				return !hasDummyAtom(smilesValue);
			}
		};
	}
