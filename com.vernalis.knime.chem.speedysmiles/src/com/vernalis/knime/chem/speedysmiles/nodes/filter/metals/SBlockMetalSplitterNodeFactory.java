...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.hasSBlockMetal;
 ...
 * @author S Roughley
 */
public class SBlockMetalSplitterNodeFactory
	...
	public AbstractSpeedySmilesFilterNodeModel createNodeModel() {
		return new AbstractSpeedySmilesFilterNodeModel(true) {
			...
			protected boolean rowMatches(String smilesValue) {
				return !hasSBlockMetal(smilesValue);
			}
		};
	}
