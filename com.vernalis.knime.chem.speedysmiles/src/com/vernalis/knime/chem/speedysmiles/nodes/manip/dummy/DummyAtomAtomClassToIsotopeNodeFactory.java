...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.dummyAtomAtomLabelToIsotope;

/**
 * @author s.roughley
 *
 */
public class DummyAtomAtomClassToIsotopeNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory.createAdapterCell(
						dummyAtomAtomLabelToIsotope(smilesValue));
			}
			...
			protected String getColumnNamePrefix() {
				return "Dummy Atom Isotope-labelled";
			}
