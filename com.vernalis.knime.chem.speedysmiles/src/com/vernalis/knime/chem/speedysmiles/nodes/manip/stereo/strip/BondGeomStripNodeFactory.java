...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.stripDoubleBondGeometry;

/**
 * @author s.roughley
 *
 */
public class BondGeomStripNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory.createAdapterCell(
						stripDoubleBondGeometry(smilesValue));
			}
