 ...
 *******************************************************************************/
package com.vernalis.knime.chem.speedysmiles.nodes.manip.stereo.strip;
...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.stripStereoCentres;

/**
 * @author s.roughley
 *
 */
public class StereoStripNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory
						.createAdapterCell(stripStereoCentres(smilesValue));
			}
