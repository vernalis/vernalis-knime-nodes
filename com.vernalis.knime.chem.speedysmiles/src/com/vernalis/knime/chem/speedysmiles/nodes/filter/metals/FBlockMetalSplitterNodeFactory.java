...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.hasFBlockMetal;
 ...
 * @author S Roughley
 */
public class FBlockMetalSplitterNodeFactory
	...
	public AbstractSpeedySmilesFilterNodeModel createNodeModel() {
		return new AbstractSpeedySmilesFilterNodeModel(true) {
			...
			protected boolean rowMatches(String smilesValue) {
				return !hasFBlockMetal(smilesValue);
			}
		};
	}
