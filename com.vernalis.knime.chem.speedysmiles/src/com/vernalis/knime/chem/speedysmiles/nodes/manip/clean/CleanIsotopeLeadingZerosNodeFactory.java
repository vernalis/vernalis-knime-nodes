...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.cleanUpLeadingIsotopeZeros;

/**
 * @author s.roughley
 *
 */
public class CleanIsotopeLeadingZerosNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory.createAdapterCell(
						cleanUpLeadingIsotopeZeros(smilesValue));
			}
