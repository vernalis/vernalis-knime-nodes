 ...
 ******************************************************************************/
package com.vernalis.knime.chem.speedysmiles.nodes.filter.brokenbonds;

import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.hasUnclosedBonds;
...
/**
 * <code>NodeFactory</code> for the SpeedySMILES broken bonds node
 *
 * @author S Roughley
 */
public class BrokenBondsFilterNodeFactory extends NodeFactory<AbstractSpeedySmilesFilterNodeModel> {
	...
	public AbstractSpeedySmilesFilterNodeModel createNodeModel() {
		return new AbstractSpeedySmilesFilterNodeModel(false) {
			...
			protected boolean rowMatches(String smilesValue) {
				return !hasUnclosedBonds(smilesValue);
			}
		};
	}
