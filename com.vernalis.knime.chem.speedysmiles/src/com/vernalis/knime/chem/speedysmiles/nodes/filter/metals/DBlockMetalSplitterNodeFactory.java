...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.hasDBlockMetal;
 ...
 * @author S Roughley
 */
public class DBlockMetalSplitterNodeFactory
	...
	public AbstractSpeedySmilesFilterNodeModel createNodeModel() {
		return new AbstractSpeedySmilesFilterNodeModel(true) {
			...
			protected boolean rowMatches(String smilesValue) {
				return !hasDBlockMetal(smilesValue);
			}
		};
	}
