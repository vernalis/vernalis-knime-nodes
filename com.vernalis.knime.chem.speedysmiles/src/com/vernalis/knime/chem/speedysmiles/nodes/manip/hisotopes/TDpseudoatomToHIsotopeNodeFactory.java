...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.replaceDTwithHIsotopes;

/**
 * @author s.roughley
 *
 */
public class TDpseudoatomToHIsotopeNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory
						.createAdapterCell(replaceDTwithHIsotopes(smilesValue));
			}
