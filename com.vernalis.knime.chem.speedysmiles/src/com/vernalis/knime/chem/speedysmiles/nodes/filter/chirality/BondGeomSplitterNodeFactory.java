...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.hasDefinedDoubleBondGeometry;
 ...
 * @author S Roughley
 */
public class BondGeomSplitterNodeFactory
	...
	public AbstractSpeedySmilesFilterNodeModel createNodeModel() {
		return new AbstractSpeedySmilesFilterNodeModel(true) {
			...
			protected boolean rowMatches(String smilesValue) {
				return hasDefinedDoubleBondGeometry(smilesValue);
			}
		};
	}
