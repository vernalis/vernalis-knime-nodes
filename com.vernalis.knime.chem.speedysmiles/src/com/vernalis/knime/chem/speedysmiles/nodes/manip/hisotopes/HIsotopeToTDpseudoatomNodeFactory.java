 ...
 *******************************************************************************/
package com.vernalis.knime.chem.speedysmiles.nodes.manip.hisotopes;
...
import static com.vernalis.knime.chem.speedysmiles.helpers.SmilesHelpers.applyDTforHIsotopes;

/**
 * @author s.roughley
 *
 */
public class HIsotopeToTDpseudoatomNodeFactory
		...
		return new AbstractSpeedySmilesSingleCellManipNodeModel(true) {
			...
			protected DataCell getResultCell(String smilesValue) {
				return SmilesCellFactory
						.createAdapterCell(applyDTforHIsotopes(smilesValue));
			}
