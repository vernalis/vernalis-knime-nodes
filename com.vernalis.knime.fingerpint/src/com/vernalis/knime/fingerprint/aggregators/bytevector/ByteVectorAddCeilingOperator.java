 ...
 * 
 */
public class ByteVectorAddCeilingOperator extends AggregationOperator {
	SparseByteVector sbv = null;
	DenseByteVector dbv = null;
	DataType colType;

	public ByteVectorAddCeilingOperator() {
		this(new OperatorData("ByteVector Add (Ceiling)",
				"ByteVector Add (Ceiling)", "ByteVector Add (Ceiling)",
				false, true, ByteVectorValue.class, false),
				GlobalSettings.DEFAULT,
				OperatorColumnSettings.DEFAULT_EXCL_MISSING);
	}

	public ByteVectorAddCeilingOperator(GlobalSettings globalSettings,
	...
	public ByteVectorAddCeilingOperator(OperatorData operatorData,
	...
	public String getDescription() {
		return "Adds counts in aggregated fingerprints.  "
				...
				+ " is replace with the ceiling value 255";
	}
	...
	public AggregationOperator createInstance(GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
		return new ByteVectorAddCeilingOperator(getOperatorData(),
