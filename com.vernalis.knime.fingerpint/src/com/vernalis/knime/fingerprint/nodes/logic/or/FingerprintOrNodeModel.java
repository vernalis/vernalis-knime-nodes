 ...
 * 
 */
public class FingerprintOrNodeModel extends AbstractDoubleFingerprintSingleOutNodeModel {

	public FingerprintOrNodeModel() {
		super(true, true, false, false, null);
	}

	@Override
	protected String getResultColumnName() {
		return "(" + m_firstColName.getStringValue() + ") OR (" + m_secondColName.getStringValue()
				+ ")";
	}
	...
	protected DataCell getBitVectorResultCell(DataCell fp1, DataCell fp2)
		...
		if (m_fpType == DenseBitVectorCell.TYPE) {
			return DenseBitVectorCellFactory.or((BitVectorValue) fp1, (BitVectorValue) fp2);
		}
		return SparseBitVectorCellFactory.or((BitVectorValue) fp1, (BitVectorValue) fp2);
	}
