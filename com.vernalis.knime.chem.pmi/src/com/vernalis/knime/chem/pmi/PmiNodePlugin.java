 ...
 ******************************************************************************/
package com.vernalis.knime.chem.pmi;
 ...
 * @author Vernalis
 */
public class PmiNodePlugin extends Plugin {
    // The shared instance.
    private static PmiNodePlugin plugin;

    /**
     * The constructor.
     */
    public PmiNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PmiNodePlugin getDefault() {
        return plugin;
    }
