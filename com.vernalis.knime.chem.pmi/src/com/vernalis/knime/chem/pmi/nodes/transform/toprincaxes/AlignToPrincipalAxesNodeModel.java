...
/**
 * This is the model implementation of Align to principal axes node to convert
 * an sd-file column to a scaffold according to the PMI plots options
 * 
 * @author S.Roughley
 */
