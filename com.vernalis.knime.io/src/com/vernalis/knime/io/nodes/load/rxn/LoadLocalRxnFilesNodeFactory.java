 ...
 *******************************************************************************/
package com.vernalis.knime.io.nodes.load.rxn;
...
/**
 * <code>NodeFactory</code> for the Load RXN Files Node
 * 
 * @author S. Roughley
 */
public class LoadLocalRxnFilesNodeFactory extends NodeFactory<AbstractLoadFilesNodeModel> {
	...
	public AbstractLoadFilesNodeModel createNodeModel() {
		return new AbstractLoadFilesNodeModel(RxnCellFactory.TYPE, "RXN Files") {

			@Override
			protected DataCell getDataCellFromString(String fileContentString) {
				return RxnCellFactory.create(fileContentString);
			}
		};
	}
	...
	public NodeDialogPane createNodeDialogPane() {
		return new AbstractLoadFilesNodeDialog(this.getClass().getName(), "rxn");
	}
