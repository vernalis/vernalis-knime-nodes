 ...
 *******************************************************************************/
package com.vernalis.knime.io.nodes.load.mol2;
...
/**
 * <code>NodeFactory</code> for the load Mol2 Files node
 * 
 * @author S. Roughley
 */
public class LoadLocalMol2FilesNodeFactory extends NodeFactory<AbstractLoadFilesNodeModel> {
	...
	public AbstractLoadFilesNodeModel createNodeModel() {
		return new AbstractLoadFilesNodeModel(Mol2CellFactory.TYPE, "mol2 Files") {

			@Override
			protected DataCell getDataCellFromString(String fileContentString) {
				return Mol2CellFactory.create(fileContentString);
			}
		};
	}
	...
	public NodeDialogPane createNodeDialogPane() {
		return new AbstractLoadFilesNodeDialog(this.getClass().getName(), "mol2");
	}
