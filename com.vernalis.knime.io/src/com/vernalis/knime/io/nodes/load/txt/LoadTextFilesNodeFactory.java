 ...
 *******************************************************************************/
package com.vernalis.knime.io.nodes.load.txt;
...
/**
 * <code>NodeFactory</code> for the "LoadTextFiles" Node.
 * 
 * @author S. Roughley
 */
public class LoadTextFilesNodeFactory extends NodeFactory<AbstractLoadFilesNodeModel> {
	...
	public AbstractLoadFilesNodeModel createNodeModel() {
		return new AbstractLoadFilesNodeModel() {

			@Override
			protected DataCell getDataCellFromString(String fileContentString) {
				return new StringCell(fileContentString);
			}
		};
	}
