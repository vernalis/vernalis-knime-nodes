 ...
 ******************************************************************************/
package com.vernalis.knime.fingerprint;
 ...
 * @author S. Roughley
 */
public class SparseToDenseNodePlugin extends Plugin {
    // The shared instance.
    private static SparseToDenseNodePlugin plugin;

    /**
     * The constructor.
     */
    public SparseToDenseNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SparseToDenseNodePlugin getDefault() {
        return plugin;
    }
