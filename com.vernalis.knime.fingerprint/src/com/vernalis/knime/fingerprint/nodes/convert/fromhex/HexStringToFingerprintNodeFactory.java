 ...
 *
 */
public class HexStringToFingerprintNodeFactory extends AbstractStringToFingerprintNodeFactory {

	public HexStringToFingerprintNodeFactory() {
		super(FingerprintStringTypes.HEX);
	}

	@Override
	public HexStringToFingerprintNodeModel createNodeModel() {
		return new HexStringToFingerprintNodeModel();
	}
