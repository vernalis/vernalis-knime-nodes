 ...
 *
 */
public class FingerprintXorNodeFactory
		extends AbstractDoubleFingerprintNodeFactory<FingerprintXorNodeModel> {

	public FingerprintXorNodeFactory() {
		super(true, true, false, false, "Fingerprint XOR", "fingerprint_XOR.png",
				"Perform logic XOR operation on a pair of binary (bitvector) fingerprint columns",
				new String[] {
						"This node performs a logic XOR operation on two selected binary "
				...
				"XOR'd Fingerprints", "Output table with combined fingerprints");
	}

	@Override
	protected FingerprintXorNodeModel createNodeModel(boolean allowSparseBitVector2,
			boolean allowDenseBitVector2, boolean allowSparseByteVector2,
			boolean allowDenseByteVector2) {
		return new FingerprintXorNodeModel();
	}
}
