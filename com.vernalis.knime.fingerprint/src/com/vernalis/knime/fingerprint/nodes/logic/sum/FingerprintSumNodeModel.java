...
public class FingerprintSumNodeModel extends AbstractDoubleFingerprintSingleOutNodeModel {

	public FingerprintSumNodeModel() {
		super(false, false, true, true, null);
	}

	@Override
	protected String getResultColumnName() {
		return "SUM (" + m_firstColName.getStringValue() + ", " + m_secondColName.getStringValue()
				+ ")";
	}
	...
	protected DataCell getByteVectorResultCell(DataCell fp1, DataCell fp2)
		...
		if (m_fpType == DenseByteVectorCell.TYPE) {
			return DenseByteVectorCellFactory.sum(bvv1, bvv2);
		} else {
			return SparseByteVectorCellFactory.sum(bvv1, bvv2);
		}
	}
