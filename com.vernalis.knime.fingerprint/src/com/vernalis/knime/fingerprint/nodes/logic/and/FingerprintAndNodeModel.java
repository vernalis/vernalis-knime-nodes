 ...
 * 
 */
public class FingerprintAndNodeModel extends AbstractDoubleFingerprintSingleOutNodeModel {

	public FingerprintAndNodeModel() {
		super(true, true, false, false, null);
	}

	@Override
	protected String getResultColumnName() {
		return "(" + m_firstColName.getStringValue() + ") AND (" + m_secondColName.getStringValue()
				+ ")";
	}
	...
	protected DataCell getBitVectorResultCell(DataCell fp1, DataCell fp2)
		...
		if (m_fpType == DenseBitVectorCell.TYPE) {
			return DenseBitVectorCellFactory.and((BitVectorValue) fp1, (BitVectorValue) fp2);
		}
		return SparseBitVectorCellFactory.and((BitVectorValue) fp1, (BitVectorValue) fp2);
	}
