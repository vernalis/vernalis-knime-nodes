 ...
 * 
 */
public class BitVectorConcatOperator extends AggregationOperator {
	SparseBitVector sbv = null;
	DenseBitVector dbv = null;
	DataType colType;

	public BitVectorConcatOperator() {
		this(new OperatorData("Bitvector CONCATENATE", "BitVector Concatenate", "Concatenate",
				false, true, BitVectorValue.class, false), GlobalSettings.DEFAULT,
				OperatorColumnSettings.DEFAULT_EXCL_MISSING);
	}

	public BitVectorConcatOperator(GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
		this(new OperatorData("Bitvector CONCATENATE", "BitVector Concatenate", "Concatenate",
				false, true, BitVectorValue.class, false), globalSettings, opColSettings);
	}

	public BitVectorConcatOperator(OperatorData operatorData, GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
	...
	public String getDescription() {
		return "Combines Bitvector fingerprints in group using a bitvector concatenation operation";
	}
	...
	public AggregationOperator createInstance(GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
		return new BitVectorConcatOperator(getOperatorData(), globalSettings, opColSettings);
	}
