 ...
 * 
 */
public class BitVectorXorOperator extends AggregationOperator {
	SparseBitVector sbv = null;
	DenseBitVector dbv = null;
	DataType colType;

	public BitVectorXorOperator() {
		this(new OperatorData("Bitvector XOR", "Bitvector XOR", "XOR", false, true,
				BitVectorValue.class, false), GlobalSettings.DEFAULT,
				OperatorColumnSettings.DEFAULT_EXCL_MISSING);
	}

	public BitVectorXorOperator(GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
		this(new OperatorData("Bitvector XOR", "Bitvector XOR", "XOR", false, true,
				BitVectorValue.class, false), globalSettings, opColSettings);
	}

	public BitVectorXorOperator(OperatorData operatorData, GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
	...
	public String getDescription() {
		return "Combines Bitvector fingerprints in group using a logic XOR operation";
	}
	...
	public AggregationOperator createInstance(GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
		return new BitVectorXorOperator(getOperatorData(), globalSettings, opColSettings);
	}
