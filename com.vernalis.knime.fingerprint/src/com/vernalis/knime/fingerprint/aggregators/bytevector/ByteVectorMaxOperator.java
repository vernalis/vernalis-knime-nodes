 ...
 * 
 */
public class ByteVectorMaxOperator extends AggregationOperator {
	SparseByteVector sbv = null;
	DenseByteVector dbv = null;
	DataType colType;

	public ByteVectorMaxOperator() {
		this(new OperatorData("ByteVector Max", "ByteVector Max", "Max", false,
				true, ByteVectorValue.class, false), GlobalSettings.DEFAULT,
				OperatorColumnSettings.DEFAULT_EXCL_MISSING);
	}

	public ByteVectorMaxOperator(GlobalSettings globalSettings,
	...
	public ByteVectorMaxOperator(OperatorData operatorData,
	...
	public String getDescription() {
		return "Combines count fingerprints in group using a Max operator"
				+ " in which the maximum count at each"
	...
	public AggregationOperator createInstance(GlobalSettings globalSettings,
			OperatorColumnSettings opColSettings) {
		return new ByteVectorMaxOperator(getOperatorData(), globalSettings,
				opColSettings);
	}
