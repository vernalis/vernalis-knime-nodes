 ...
 * @since 1.38.0
 */
public class VernalisKnimeMiscBlobsPlugin extends Plugin {

	// The shared instance.
	private static VernalisKnimeMiscBlobsPlugin plugin;

	/**
	 * The constructor.
	 */
	public VernalisKnimeMiscBlobsPlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static VernalisKnimeMiscBlobsPlugin getDefault() {
		return plugin;
	}
