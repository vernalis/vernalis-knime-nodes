...
/**
 * NodeModel class for the Detect Archive Format node
 * 
 * @author S.Roughley knime@vernalis.com
 */
public class DetectArchiveFormatNodeModel
    ...
    protected ColumnRearranger createColumnRearranger(DataTableSpec spec)
        ...
        rearranger.append(new SingleCellFactory(new DataColumnSpecCreator(
                DataTableSpec.getUniqueColumnName(spec, "Archive Format ("
    ...
    private DataCell getTypeCellFromInputStream(BufferedInputStream bis) {
        ...
        try {
            ArchiveFormat detected = ArchiveFormat.getFormatForStream(bis);
