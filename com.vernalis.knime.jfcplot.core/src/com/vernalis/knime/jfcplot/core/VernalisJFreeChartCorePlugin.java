 ...
 *******************************************************************************/
package com.vernalis.knime.jfcplot.core;
 ...
 * @author %BundleVendor
 */
public class VernalisJFreeChartCorePlugin extends Plugin {

	// The shared instance.
	private static VernalisJFreeChartCorePlugin plugin;

	/**
	 * The constructor.
	 */
	public VernalisJFreeChartCorePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static VernalisJFreeChartCorePlugin getDefault() {
		return plugin;
	}
