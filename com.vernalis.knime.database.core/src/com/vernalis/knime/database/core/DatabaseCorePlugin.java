 ...
 * @author S Roughley
 */
public class DatabaseCorePlugin extends Plugin {
    // The shared instance.
    private static DatabaseCorePlugin plugin;

    /**
     * The constructor.
     */
    public DatabaseCorePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DatabaseCorePlugin getDefault() {
        return plugin;
    }
