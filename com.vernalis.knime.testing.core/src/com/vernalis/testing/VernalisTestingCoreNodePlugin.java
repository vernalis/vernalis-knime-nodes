 ...
 * @author S Roughley
 */
public class VernalisTestingCoreNodePlugin extends AbstractUIPlugin {

	// The shared instance.
	private static VernalisTestingCoreNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public VernalisTestingCoreNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static VernalisTestingCoreNodePlugin getDefault() {
		return plugin;
	}
